...
ren filter.sys wp81hcifilter.sys

"C:\Program Files (x86)\Windows Kits\8.1\bin\x86\signtool.exe" sign /ph /fd "sha256" /f MySPC.pfx wp81hcifilter.sys
...
ren control.sys wp81controldevice.sys

"C:\Program Files (x86)\Windows Kits\8.1\bin\x86\signtool.exe" sign /ph /fd "sha256" /f MySPC.pfx wp81controldevice.sys
